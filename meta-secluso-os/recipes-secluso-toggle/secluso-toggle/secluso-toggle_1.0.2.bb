...
SUMMARY = "Recipe to build and install Secluso Toggle"
...
SRCREV = "151099e70e06d97e94c1c3e39dc35bd65c2180b8"
...
SYSTEMD_SERVICE:${PN} = "secluso_toggle.service"
SRC_URI:append = " file://secluso_toggle.service "
FILES:${PN} += "${systemd_unitdir}/system/secluso_toggle.service"
RDEPENDS:${PN} += " systemd"
